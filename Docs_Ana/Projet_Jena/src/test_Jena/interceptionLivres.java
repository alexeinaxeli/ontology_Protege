...
public class interceptionLivres {
	...
	public static void main(String[] args) {
		...
		Model modeloUnion = modeloLivres.intersection(modeloTestLivres);
		modeloUnion.write(System.out, "RDF/XML");
		
		try {
			FileOutputStream fos = new FileOutputStream("rdf/intersectionFichier.rdf");
